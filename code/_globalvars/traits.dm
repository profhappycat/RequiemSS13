...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_EYES_VIOLATING_MASQUERADE" = TRAIT_EYES_VIOLATING_MASQUERADE,
		"TRAIT_GECKO_GRIP" = TRAIT_GECKO_GRIP,
		"TRAIT_QUICK_JUMP" = TRAIT_QUICK_JUMP,
		"TRAIT_NO_QUICK_EQUIP" = TRAIT_NO_QUICK_EQUIP,
		"TRAIT_ATTENDING_CARNIVAL" = TRAIT_ATTENDING_CARNIVAL,
		"TRAIT_COMPEL_THINK_TWICE" = TRAIT_COMPEL_THINK_TWICE,
		"TRAIT_COMMAND_FALL" = TRAIT_COMMAND_FALL,
		"TRAIT_COMMAND_BE_QUIET" = TRAIT_COMMAND_BE_QUIET,
		"TRAIT_COMMAND_SIT_DOWN" = TRAIT_COMMAND_SIT_DOWN,
		"TRAIT_ENRAPTURED" = TRAIT_ENRAPTURED,
		"TRAIT_CHARMED" = TRAIT_CHARMED,

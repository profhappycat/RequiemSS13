...
//===========GENERAL===========
	...
	//STATS
	WRITE_FILE(S["physique"], stats.get_stat(PHYSIQUE))
	WRITE_FILE(S["stamina"], stats.get_stat(VITALITY))
	WRITE_FILE(S["charisma"], stats.get_stat(CHARISMA))
	WRITE_FILE(S["composure"], stats.get_stat(COMPOSURE))
	WRITE_FILE(S["wits"], stats.get_stat(WITS))
	WRITE_FILE(S["resolve"], stats.get_stat(RESOLVE))

//AURA PERCEPTION
/datum/discipline_power/vtr/auspex/minor_telepathy
...
/datum/discipline_power/vtr/auspex/minor_telepathy/pre_activation_checks(mob/living/carbon/human/target)
...
/datum/discipline_power/vtr/auspex/minor_telepathy/activate(atom/target)
	. = ..()
...
/datum/discipline_power/vtr/auspex/minor_telepathy/proc/ask_last_words(mob/living/carbon/human/target, question)
...
/datum/discipline_power/vtr/auspex/minor_telepathy/proc/ask_name(mob/living/carbon/human/target, question)
	to_chat(owner, span_notice("A name whispers on the wind: \"[target.true_real_name]\""))

/datum/discipline_power/vtr/auspex/minor_telepathy/proc/ask_bonds(mob/living/carbon/human/target, question)
	if(!target.mind)
...
/datum/discipline_power/vtr/auspex/minor_telepathy/proc/ask_prompt(mob/living/carbon/human/target, question)
	if(!target.mind)

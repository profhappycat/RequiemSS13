...
/datum/discipline_power/vtr/obfuscate/face_in_the_crowd/proc/choose_impersonating()
	initialize_original()
...
/datum/discipline_power/vtr/obfuscate/face_in_the_crowd/proc/shapeshift(to_original = FALSE)
